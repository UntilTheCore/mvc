...
},{"_css_loader":"../../../../../AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/css-loader.js"}],"css/global.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var _default = c; // import '../css/app1.css'
// import $ from 'jquery'
//
//
// const v = `
...
var v = {
  ...
  html: function html(index) {
    return "\n      <ul class=\"tabs\">\n        <li class=\"".concat(index === 0 ? 'selected' : '', "\" data-index=\"0\"><span>tab1</span></li>\n        <li class=\"").concat(index === 1 ? 'selected' : '', "\" data-index=\"1\"><span>tab2</span></li>\n      </ul>\n      <ul class=\"contents\">\n        <li class=\"").concat(index === 0 ? 'active' : '', "\">\u5185\u5BB91</li>\n        <li class=\"").concat(index === 1 ? 'active' : '', "\">\u5185\u5BB92</li>\n      </ul>\n");
  },
  init: function init(container) {
    v.el = (0, _jquery.default)(container);
  },
...
(0, _jquery.default)(v).appendTo((0, _jquery.default)('body > .page')); // 默认在左边

var isActive = parseInt(localStorage.getItem('app3'));
isActive = isActive ? isActive : 0;

if (isActive) {
  (0, _jquery.default)('.square').addClass('active');
} else {
  (0, _jquery.default)('.square').removeClass('active');
}

(0, _jquery.default)('#app3 > .square').click(function (e) {
  console.log(isActive);

  if (0 === isActive) {
    (0, _jquery.default)(e.target).toggleClass('active', isActive);
    isActive = 1;
  } else {
    (0, _jquery.default)(e.target).toggleClass('active', isActive);
    isActive = 0;
...
(0, _jquery.default)(v).appendTo((0, _jquery.default)('body > .page'));
(0, _jquery.default)('.circle').on('mouseenter', function (e) {
  (0, _jquery.default)('.circle').addClass('active');
});
(0, _jquery.default)('.circle').on('mouseleave', function (e) {
...
},{"./css/reset.css":"css/reset.css","./css/global.css":"css/global.css","./js/app1":"js/app1.js","./js/app2":"js/app2.js","./js/app3":"js/app3.js","./js/app4":"js/app4.js"}],"../../../../../AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14072" + '/');
